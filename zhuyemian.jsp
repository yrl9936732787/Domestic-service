	...
	<div >
		<div >
			<nav class="navbar navbar-default navbar-static-top"
				role="navigation" style="background-color:#ffffff;margin-top:15px;">
			<div class="container-fluid">
				...
				<div>
					<ul class="nav navbar-nav">
						...
						<li style="margin-left: 450px;"><a href="index.jsp">登陆</a></li>
						<li><a>|</a></li>
